...
?>
            ...
            ?>
                    ...
                    <div class="row rhoRowMargin">
                        ...
                        ?>
                            <fieldset class="basic_person_fs">
                                <legend class="basic_person_lg">User Summary Information</legend>
                                <div class="col-md-4">
                ...
                <div class="row">
                    <fieldset class="">
                        <legend class="basic_person_lg">Assigned User Roles</legend>
                        <div class="row">
                            <?php
                            if ($canEdtUsers === true) {
                                    ...
                                    <table class="table table-striped table-bordered table-responsive" id="usrPrflTable" cellspacing="0" width="100%" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row1 = loc_db_fetch_array($result1)) {
                                                $cntr += 1;
                                                $chckd = "";
                                                if ($slctd !== ";;" && strpos($slctd, ";" . $row1[3] . ";") === false) {
                                                    $chckd = "";
                                                } else if ($slctd !== ";;") {
                                            ...
                                            ?>
                                                <tr id="usrPrflRow<?php echo $cntr; ?>">
                                                    <!--<td><input type="checkbox" name="usrPrflChkbx<?php echo $cntr; ?>" value="<?php echo $row1[3] . ";" . $row1[1]; ?>" <?php echo $chckd ?>></td>-->
                                                    <td class="lovtd"><?php echo ($curIdx * $lmtSze) + ($cntr); ?></td>
                                                    <?php if ($canEdtUsers === true) { ?>
                                                    <?php } ?>
