                                                                            ...
                                                                            $nwRowHtml2 .= "</select>                                            
                                                                                        ...
                                                                                        <td class=\"lovtd\">
                                                                                            <div class=\"input-group\" style=\"width:100% !important;\">
                                                                                                ...
                                                                                                <label id=\"payGlblValsRunDetsRow_WWW123WWW_GrpNmLbl\" class=\"btn btn-primary btn-file input-group-addon\" onclick=\"getNoticeLovsTblr('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Business/Trade Partners', 'allOtherInputOrgID', '', '', 'radio', true, '', 'payGlblValsRunDetsRow_WWW123WWW_CrtriaID', 'payGlblValsRunDetsRow_WWW123WWW_CrtriaNm', 'clear', 1, '', 'payGlblValsRunDetsRow_WWW123WWW_CrtriaType');\">
                                                                                    ...
                                                                                    <tr id="payGlblValsRunDetsRow_<?php echo $cntr; ?>">                                    
                                                                                        ...
                                                                                        <td class="lovtd">
                                                                                            <div class="input-group" style="width:100% !important;">
                                                                                                ...
                                                                                                <label id="payGlblValsRunDetsRow<?php echo $cntr; ?>_GrpNmLbl" class="btn btn-primary btn-file input-group-addon" onclick="getNoticeLovsTblr('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Business/Trade Partners', 'allOtherInputOrgID', '', '', 'radio', true, '', 'payGlblValsRunDetsRow<?php echo $cntr; ?>_CrtriaID', 'payGlblValsRunDetsRow<?php echo $cntr; ?>_CrtriaNm', 'clear', 1, '', 'payGlblValsRunDetsRow<?php echo $cntr; ?>_CrtriaType');">
                                                                                                    <span class="glyphicon glyphicon-th-list"></span>
                                                                                                </label>
                                                                                            </div> 
                                                                                        </td> 
