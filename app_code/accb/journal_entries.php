            ...
            if ($actyp == 1) {
                ...
                if ($inptNum >= 0) {
                    ...
                    if ($z == 0) {
                        ...
                        $arr_content['msgcount'] = 0;
                        file_put_contents(
                            $ftp_base_db_fldr . "/bin/log_files/$lgn_num" . "_DebitCreditTrnsExprt_progress.rho",
                            json_encode($arr_content)
                        );
                    }
                    fclose($opndfile);
                ...
                if ($inptNum >= 0) {
                    ...
                    if ($z == 0) {
                        ...
                        $arr_content['msgcount'] = 0;
                        file_put_contents(
                            $ftp_base_db_fldr . "/bin/log_files/$lgn_num" . "_IncrsDcrsTrnsExprt_progress.rho",
                            json_encode($arr_content)
                        );
                    }
                    fclose($opndfile);
                ...
                if ($inptNum >= 0) {
                    ...
                    if ($z == 0) {
                        ...
                        $arr_content['msgcount'] = 0;
                        file_put_contents(
                            $ftp_base_db_fldr . "/bin/log_files/$lgn_num" . "_SimplifiedTrnsExprt_progress.rho",
                            json_encode($arr_content)
                        );
                    }
                    fclose($opndfile);
                                ...
                                <div class="form-group">
                                    ...
                                    <div  class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'Transaction Accounts', 'allOtherInputOrgID', '', '', 'radio', true, '', 'jrnlBatchDfltBalsAcntID', 'jrnlBatchDfltBalsAcnt', 'clear', 1, '', function () {});">
                                                <span class="glyphicon glyphicon-th-list"></span>
                                            </label>
                                        </div>
                                    </div>
