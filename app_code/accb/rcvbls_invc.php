                                ...
                                <div class="form-group">
                                    ...
                                    <div  class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Business/Trade Partners', 'allOtherInputOrgID', '', 'accbRcvblsInvcCstmrClsfctn', 'radio', true, '', 'accbRcvblsInvcCstmrID', 'accbRcvblsInvcCstmr', 'clear', 1, '', function () {
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div  class="col-md-8">
                                                            <div class="input-group">
                                                                ...
                                                                <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'Asset Accounts', 'allOtherInputOrgID', '', '', 'radio', true, '', 'accbRcvblsInvcDfltBalsAcntID', 'accbRcvblsInvcDfltBalsAcnt', 'clear', 1, '', function () {});">
                                                                    <span class="glyphicon glyphicon-th-list"></span>
                                                                </label>
                                                            </div>
                                                        </div>
