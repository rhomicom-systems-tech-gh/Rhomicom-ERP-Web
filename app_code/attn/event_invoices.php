                                ...
                                <div class="form-group">
                                    ...
                                    <div  class="col-md-8"> 
                                        <div class="input-group" style="width:100% !important;">
                                            ...
                                            <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'All Business/Trade Partners', 'allOtherInputOrgID', 'scmSalesLnkdPrsnID', 'scmSalesInvcCstmrClsfctn', 'radio', true, '', 'hotlChckinDocSpnseeID', 'hotlChckinDocSpnsee', 'clear', 1, '', function () {
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div  class="col-md-8">
                                                                <div class="input-group">
                                                                    ...
                                                                    <label class="btn btn-primary btn-file input-group-addon" onclick="getLovsPage('myLovModal', 'myLovModalTitle', 'myLovModalBody', 'Liability Accounts', 'allOtherInputOrgID', '', '', 'radio', true, '', 'scmSalesInvcDfltBalsAcntID', 'scmSalesInvcDfltBalsAcnt', 'clear', 1, '', function () {});">
                                                                        <span class="glyphicon glyphicon-th-list"></span>
                                                                    </label>
                                                                </div>
                                                            </div>
